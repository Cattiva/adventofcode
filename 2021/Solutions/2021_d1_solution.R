...
#First calculate the new 3-measure rolling window (could surely use something like Rcpp::roll_sum, too)
...
get_in_or_decrease(new_measures) #reuse the first function
